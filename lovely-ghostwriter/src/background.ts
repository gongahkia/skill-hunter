...
chrome.runtime.onInstalled.addListener((details) => {
  console.info('Lovely Ghostwriter installed/updated:', details.reason);

  if (details.reason === 'install') {
    // First time installation
    console.info('Welcome to Lovely Ghostwriter!');
...
console.info('Lovely Ghostwriter background service worker initialized');
